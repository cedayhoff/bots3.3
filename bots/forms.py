...
class SelectIncoming(Select):
    ...
    idroute = django.forms.ChoiceField(
        choices=[],
        required=False,
        initial=''
    )
    ...
    ineditype = django.forms.ChoiceField(
        choices=models.EDITYPESLIST,
        required=False
    )
    inmessagetype = django.forms.ChoiceField(choices=[], required=False)
    outeditype = django.forms.ChoiceField(
        choices=models.EDITYPESLIST,
        required=False
    )
...
class SelectDocument(Select):
    ...
    status = django.forms.TypedChoiceField(
        choices=[(0,'---------'), (320,'Document-in'), (330,'Document-out')],
        required=False,
        initial=0,
        coerce=int
    )
    ...
    messagetype = django.forms.ChoiceField(required=False, choices=[])
    lastrun = django.forms.BooleanField(required=False, initial=False)
...
class SelectConfirm(Select):
    ...
    confirmtype = django.forms.ChoiceField(
        choices=models.CONFIRMTYPELIST,
        required=False,
        initial='0'
    )
...
class PlugoutForm(django.forms.Form):
    databaseconfiguration = django.forms.BooleanField(required=False, initial=True, label='Database configuration',
    ...
    fileconfiguration = django.forms.BooleanField(required=False, initial=True, label='Script files',
...
class DeleteForm(django.forms.Form):
    delacceptance = django.forms.BooleanField(required=False,
